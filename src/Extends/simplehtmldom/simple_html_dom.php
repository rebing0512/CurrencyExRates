...
function dump_html_tree_info($node, $show_attr = true, $deep = 0)
{
    $node->dump($node);
}

class simple_html_dom_node_info
{
...
class simple_html_dom_info
{
        ...
        $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        ...
        $this->root = new simple_html_dom_node_info($this);
        $this->root->tag = 'root';
    ...
    protected function parse()
    {
        while (true) {
            ...
            $node = new simple_html_dom_node_info($this);
            ++$this->cursor;
    ...
    {
        return @str_get_html_info("<$name>$value</$name>")->firstChild();
    }

    function createTextNode($value)
    {
        return @end(str_get_html_info($value)->nodes);
    }
